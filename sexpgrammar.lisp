...
(defun test-create-first-tables0()
  (let ((first-table (create-first-tables *terminals* *nonterminals* *grammar*)))
    (dolist (X *nonterminals*)
      (format t "term = ~a: " X)
      (print
...
(defun test-create-first-tables2()
