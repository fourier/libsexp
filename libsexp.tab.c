...
/* Tokens.  */
#define ATOM 258
#define OPENPAREN 259
#define CLOSEPAREN 260
...
{
  "$end", "error", "$undefined", "ATOM", "OPENPAREN", "CLOSEPAREN",
  "$accept", "program", "sexp", "list", "list_contents", 0
};
#endif
